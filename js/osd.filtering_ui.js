...
_nn+=' <div class="panel panel-default col-md-12"> <input type="checkbox" id="'+_visible_name+'" class="pull-left" checked="" style="margin:10px"  onClick="toggleItem('+i+',\''+name+'\')" />';
 ...
 if(alias != null)
   aname=alias;
_nn+=' <div class="panel-heading"> <h5 class="row panel-title" style="background-color:transparent;"><a class="accordion-toggle" data-toggle="collapse" data-parent="#itemList" href="#' +_collapse_name+'">'+aname+'</a> </h5></a> </div>';
